...
> **Vault note:** This README matches the solved run documented in `notes/ctf/htb-precious.md`. Redact flags, hashes, and passwords if you publish a public writeup.
