...
> **Vault note:** This README matches the solved run documented in `notes/ctf/htb-boardlight.md`. Redact flags, hashes, and passwords if you publish a public writeup.
