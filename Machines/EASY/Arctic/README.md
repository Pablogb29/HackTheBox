...
author: "M0k4"
date: "2026-05-26"
tags: ["htb", "writeup", "windows", "easy", "coldfusion,", "directorytraversal,", "lfi,", "jsp-reverseshell,", "juicypotato,", "windows-privilegeescalation"]
---
# HTB - Arctic
...
![Ping](cases/HackTheBox/Machines/EASY/Arctic/screenshots/ping.png)  
...
![Nmap all ports](cases/HackTheBox/Machines/EASY/Arctic/screenshots/allports.png)  
...
```
![ExtractPorts](cases/HackTheBox/Machines/EASY/Arctic/screenshots/extractports.png)  
...
![Targeted Scan](cases/HackTheBox/Machines/EASY/Arctic/screenshots/targeted.png)  
...
![Web port 8500](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_port_8500.png)  

Deeper exploration shows the `CFIDE` directory:

![CFIDE directory](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_8500_CFIDE.png)  

Key findings:
- The **administrator** directory is exposed  
- Pages use the `.cfm` extension (ColdFusion Markup)

![Administrator login page](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_8500_CFIDE_administrator.png)  

Testing authentication with random credentials shows encrypted values in the textbox: 

![Encrypted password field](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_password_encrypted.png)  
...
![Inspection changing input type](cases/HackTheBox/Machines/EASY/Arctic/screenshots/inspection_password_to_type.png)  
...
![Searchsploit ColdFusion](cases/HackTheBox/Machines/EASY/Arctic/screenshots/searchsploit_coldfusion.png)  
...
![Exploit details](cases/HackTheBox/Machines/EASY/Arctic/screenshots/searchsploit_download_sploit.png)  
...
![LFI password.properties](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_port_8500_CFIDE_administrator_enter.png)  

This reveals the **password hash**, which is then cracked with CrackStation:  

![Cracked password](cases/HackTheBox/Machines/EASY/Arctic/screenshots/crackstation.png)  

Password `happyday` obtained.

Login successful:  

![Successful login](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_login.png)  
...
![Mappings panel](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_mapping.png)  
...
![Scheduled Tasks panel](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_scheduled_tasks.png)  
...
![MSFvenom payloads](cases/HackTheBox/Machines/EASY/Arctic/screenshots/msfvenom_payloads.png)  
...
![Executing task](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_executing_task.png)  

Confirm the upload in our server:

![Python server](cases/HackTheBox/Machines/EASY/Arctic/screenshots/python_server_reverse.png)  

And in directory:

![Uploaded reverse.jsp](cases/HackTheBox/Machines/EASY/Arctic/screenshots/web_port_8500_CFIDE_reverse_uploaded.png)  
...
![User flag](cases/HackTheBox/Machines/EASY/Arctic/screenshots/user_flag.png)  
...
![User privileges](cases/HackTheBox/Machines/EASY/Arctic/screenshots/user_priv.png)  
...
![Executing JuicyPotato](cases/HackTheBox/Machines/EASY/Arctic/screenshots/executing_JP.png)  

We catch the connection on port 4646 and obtain SYSTEM:  

![Root flag](cases/HackTheBox/Machines/EASY/Arctic/screenshots/root_flag.png)  
